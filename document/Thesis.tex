...
\title{Clasificación de similitud entre códigos de C\#}
\author{\\\vspace{0.25cm}
María de Lourdes Choy Fernández}
\advisor{\\\vspace{0.25cm}Rodrigo García Gomez \\\vspace{0.2cm}Alberto Fernández Oliva}
\degree{Licenciado en Ciencia de la Computación}
\faculty{Facultad de Matemática y Computación}
\date{febrero de 2024\\\vspace{0.25cm}\href{https://github.com/Chonyyy/Code_Similarity}{github.com/Chonyyy/Code\_Similarity}}
